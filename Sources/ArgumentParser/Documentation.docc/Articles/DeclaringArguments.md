...
@Snippet(path: "swift-argument-parser/DeclaringArguments/Declaring1-example")
...
@Snippet(path: "swift-argument-parser/DeclaringArguments/Declaring2-defaults")
...
@Snippet(path: "swift-argument-parser/DeclaringArguments/Declaring3-array")
...
@Snippet(path: "swift-argument-parser/DeclaringArguments/Declaring4-customizing")
...
@Snippet(path: "swift-argument-parser/DeclaringArguments/Declaring5-types")
...
@Snippet(path: "swift-argument-parser/DeclaringArguments/Declaring6-raw")
...
@Snippet(path: "swift-argument-parser/DeclaringArguments/Declaring7-transform")
...
@Snippet(path: "swift-argument-parser/DeclaringArguments/Declaring8-inversion")
...
@Snippet(path: "swift-argument-parser/DeclaringArguments/Declaring9-customFlag")
...
@Snippet(path: "swift-argument-parser/DeclaringArguments/Declaring10-intFlag")
...
@Snippet(path: "swift-argument-parser/DeclaringArguments/Declaring11-customDefaults")
...
@Snippet(path: "swift-argument-parser/DeclaringArguments/Declaring12-parsing")
...
@Snippet(path: "swift-argument-parser/DeclaringArguments/Declaring13-altParsing")
...
@Snippet(path: "swift-argument-parser/DeclaringArguments/Declaring14-altPositional")
