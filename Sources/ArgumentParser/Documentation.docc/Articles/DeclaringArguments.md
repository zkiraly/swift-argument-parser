...
@Snippet(path: "swift-argument-parser/ArgumentParser/Declaring1-example")
...
@Snippet(path: "swift-argument-parser/ArgumentParser/Declaring2-defaults")
...
@Snippet(path: "swift-argument-parser/ArgumentParser/Declaring3-array")
...
@Snippet(path: "swift-argument-parser/ArgumentParser/Declaring4-customizing")
...
@Snippet(path: "swift-argument-parser/ArgumentParser/Declaring5-types")
...
@Snippet(path: "swift-argument-parser/ArgumentParser/Declaring6-raw")
...
@Snippet(path: "swift-argument-parser/ArgumentParser/Declaring7-transform")
...
@Snippet(path: "swift-argument-parser/ArgumentParser/Declaring8-inversion")
...
@Snippet(path: "swift-argument-parser/ArgumentParser/Declaring9-customFlag")
...
@Snippet(path: "swift-argument-parser/ArgumentParser/Declaring10-intFlag")
...
@Snippet(path: "swift-argument-parser/ArgumentParser/Declaring11-customDefaults")
...
@Snippet(path: "swift-argument-parser/ArgumentParser/Declaring12-parsing")
...
@Snippet(path: "swift-argument-parser/ArgumentParser/Declaring13-altParsing")
...
@Snippet(path: "swift-argument-parser/ArgumentParser/Declaring14-altPositional")
