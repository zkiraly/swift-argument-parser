...
@Snippet(path: "swift-argument-parser/Validation/Validation1")
...
@Snippet(path: "swift-argument-parser/Validation/Validation2-post")
...
@Snippet(path: "swift-argument-parser/Validation/Validation3-exitCode")
...
@Snippet(path: "swift-argument-parser/Validation/Validation4-errors")
