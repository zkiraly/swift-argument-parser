...
@Snippet(path: "swift-argument-parser/ArgumentParser/Validation1")
...
@Snippet(path: "swift-argument-parser/ArgumentParser/Validation2-post")
...
@Snippet(path: "swift-argument-parser/ArgumentParser/Validation3-exitCode")
...
@Snippet(path: "swift-argument-parser/ArgumentParser/Validation4-errors")
